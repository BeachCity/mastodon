...
class Header extends ImmutablePureComponent {
  ...
  render () {
    ...
    const badge           = account.get('bot') || account.get('bot_identified') ? (<div className='account-role bot'><FormattedMessage id='account.badges.bot' defaultMessage='Bot' /></div>) : null;
